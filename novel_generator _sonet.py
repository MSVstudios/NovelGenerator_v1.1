...
# Setting up the Anthropic client with the provided API key and model
client = anthropic.Anthropic(api_key="Your API-key here")

class BookGenerator:
    def __init__(self):
        # Using the Claude Sonnet model
        self.model = "claude-3-5-sonnet-20241022"
        self.story_premise = ""
        self.num_chapters = 0
        self.story_outline = ""
        self.chapters = []
        self.characters = {}  # Stores character information
        self.chapter_summaries = {}  # Detailed chapter summaries
        self.settings = {}  # Locations/settings
        self.plot_events = []  # Main plot events
        self.world_name = ""  # World name for maintaining consistency
        self.chapter_plan = ""  # Detailed chapter plan
        self.timeline = {}  # Timeline information
        self.emotional_arc = {}  # Emotional dynamics of chapters
        self.transitions = {}  # Transitions between chapters
        self.recurring_motifs = []  # Recurring motifs for narrative unity

    def get_user_input(self):
        """Gets user input: story premise and number of chapters"""
        print(
            """
──────────────────────────────────────────────────────────────────────────────────
                      N O V E L   G E N E R A T O R   2 . 5
──────────────────────────────────────────────────────────────────────────────────
ENGINE: Running on Claude Sonnet with claude-3-5-sonnet-20241022
CAPABILITIES: Creates novels or fan fiction with consistency checking
...
"""
    ...
    def generate_text(self, prompt, system_prompt="You are a creative fiction writer."):
        """Sends a request to the Claude Sonnet API with the given prompt"""
        # Combine the system message and the prompt
        ...
        try:
            ...
            # Extract the response text (according to the provided template)
            return response.content[0].text
        except Exception as e:
            print(f"Error while requesting the Claude Sonnet API: {e}")
            return None
    ...
    def extract_world_name(self, outline):
        """Extracts the world name from the overall story outline to ensure consistency"""
        patterns = [
            r"Neo-[A-Za-z]+",
            r"[A-Z][a-z]+land",
            r"[A-Z][a-z]+ Kingdom",
    ...
    def create_story_outline(self):
        """Generates an overall story outline with a detailed description of chapters, world, characters, and motifs"""
...
"""
        print("Generating detailed chapter plan...")
    ...
    def create_chapter_summary(self, chapter_num, chapter_content):
        """Creates a detailed chapter summary to ensure narrative consistency"""
...
"""
    ...
    def track_emotional_arc(self, chapter_num, chapter_content):
        """Analyzes emotional dynamics at the end of the chapter"""
...
"""
    ...
    def create_next_chapter_opener(self, chapter_num):
        """Creates a strong opening for the next chapter that seamlessly connects with previous events"""
        if chapter_num <= 1:
            return ""
...
"""
    ...
    def validate_chapter_consistency(self, chapter_num, chapter_content):
        """Checks the chapter for inconsistencies with previous parts of the narrative"""
...
"""
    ...
    def fix_chapter_inconsistencies(self, chapter_num, chapter_content, issues):
        """Fixes identified inconsistencies in the chapter"""
...
"""
        ...
        print(f"Updating character information for Chapter {chapter_num}...")
        ...
        print(f"Analyzing emotional dynamics for Chapter {chapter_num}...")
        self.track_emotional_arc(chapter_num, chapter_content)

        if chapter_num < self.num_chapters:
            print(f"Creating transition for the end of Chapter {chapter_num}...")
    ...
    def check_chapter_transitions(self):
        """Performs a final check of transitions between chapters and improves them if necessary"""
        print("Performing final check of transitions between chapters...")
        improved_chapters = []
...
"""
        ...
        print("Chapter transitions optimized.")

    def generate_book(self):
        """Generates the entire novel with consistency checking"""
        self.get_user_input()
        ...
        for i in range(1, self.num_chapters + 1):
            ...
            if i < self.num_chapters:
                print("A short pause before generating the next chapter...")
                time.sleep(3)
    ...
    def compile_book(self):
        """Combines all chapters into one novel text"""
...
"""
    ...
    def save_book(self, book_content, filename="generated_book.md"):
        """Saves the generated novel to a file"""
        ...
        print("Novel metadata saved as book_metadata.json")
